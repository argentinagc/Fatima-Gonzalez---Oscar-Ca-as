	...
	<div class="barra">
		...
		<div class="container">
			...
			<?php else: ?>
				...
				<!--
				<li class="nav-item">
					<a class="nav-link active" href="index.php?pagina=registrarCurso">Registro Curso</a>
				</li>
				<li class="nav-item">
					<a class="nav-link active" href="index.php?pagina=registrarNotas">Registro Notas</a>
				</li>

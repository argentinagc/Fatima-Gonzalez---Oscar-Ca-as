...
<form class="p-5 bg-light" method="post">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="date" class="form-control" id="FechaIngreso" name="registroFechaIngreso">
...
<div class="input-group">
    ...
    <input type="number" class="form-control" id="Estado" name="registroEstado">
    ...
    <button type="submit" class="boton-estudiante">Agregar estudiante</button>
